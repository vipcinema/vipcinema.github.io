    ...
    if (!window.museConfigLoadedAndExecuted) {
        ...
        var d = {
            ...
            paths: {
                ...
                "jquery.museoverlay": "scripts/jquery.museoverlay.js?crc=520420588",
                "jquery.musepolyfill.bgsize": "scripts/jquery.musepolyfill.bgsize.js?crc=4045269973",
                "jquery.museresponsive": "scripts/jquery.museresponsive.js?crc=3991588253",
                ...
                "museutils": "scripts/museutils.js?crc=388970469",
                "musewpdisclosure": "scripts/musewpdisclosure.js?crc=403040780",
                "musewpslideshow": "scripts/musewpslideshow.js?crc=143296732",
                ...
                "webpro": "scripts/webpro.js?crc=4077264916",
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2018.0.0.379" != d.getAttribute("content") && Muse.assets.outOfDate.push("museconfig.js");
                    break
                }
            }
        }
