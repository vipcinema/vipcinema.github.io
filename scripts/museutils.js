...
(function(c) {
    ...
    Muse.Utils.firstDescendant = function(a, b, c) {
        for (var d = 0; d < a.childNodes.length; d++) {
            ...
            if (l.nodeType == 1) {
                if (!b || b.matches(l)) return l;
                if (!c || !c.matches(l))
                    if (l = Muse.Utils.firstDescendant(l, b, c)) return l
            }
        }
        return null
    };
    ...
    Muse.Utils.appendChildren = function(a, b) {
        if (a.length && b.length && b.find(".fld-grp[data-type = 'recaptcha2']").length)
    ...
    Muse.Utils.getPageStyleSheets = function() {
        for (var a = [],
                b = 0; b < document.styleSheets.length; ++b) {
    ...
    Muse.Utils.allStyleSheetRules = function(a, b) {
        for (var c = [], d = 0; d < a.length; d++) {
            var l = Muse.Utils.allStyleSheetRulesFromOneSheet(a[d], b);
            l && (c = c.concat(l))
        }
        return c.length ?
            c : null
    ...
    Muse.Utils.allStyleSheetRulesFromOneSheet = function(a, b) {
        ...
        if (!g) d = !0, g = a.rules;
        if (!g) return null;
        for (var j = [], k = c(window), i = function(a) {
            ...
            var n = g[m];
            if (i(n)) {
                if (n = Muse.Utils.allStyleSheetRulesFromOneSheet(n, b), null != n)
                    for (var q = 0; q < n.length; q++) j.push(n[q])
            } else if (Muse.Utils.isDefined(n.selectorText))
                if (d) b(n.selectorText) &&
                    j.push(n);
                else
                    for (var q = n.selectorText.split(/\s*,\s*/), p = 0; p < q.length; p++) b(q[p]) && j.push(n)
        }
    ...
    Muse.Utils.updateSlideshow_fstpOffsetSize = function(a) {
        var b = c(window),
            d = c(document.body),
            g = a.options,
            l = a.$clip ? a.$clip : a._findWidgetElements("." + g.clipClassName);
        Muse.Utils.moveElementsOutsideViewport(l.parents());
        a._fstpOffsetSize = g.transitionStyle === "horizontal" ? g.elastic === "fullWidth" ? Math.max(b.width(), parseInt(d.css("min-width"))) : l.width() : l.height();
        Muse.Utils.moveElementsInsideViewport(l.parents())
    };
    ...
    Muse.Utils.processHyperlink = function(a) {
        ...
        if (!g || g == "_self") {
            var l = f.lastIndexOf("/"),
                g = f.lastIndexOf("#"),
                j = a.attr("class").match(/anim_(\w+)/);
            if (j && g > l) {
                var a = d.data("scrollWrapper"),
                    k = f.substring(g),
                    i = Muse.Utils.getAnchorWithDestination(k);
                ...
                var g = i.offset(),
                    ...
                    j = (a ? a.scrollHeight() :
                        l.scrollHeight) - d.height(),
                    l = (a ? a.scrollWidth() : l.scrollWidth) - d.width(),
                    n = Math.min(j, g.top + (a && !a.isStandard() ? a.scrollTop() : 0)),
                    q = Math.min(l, g.left + (a && !a.isStandard() ? a.scrollLeft() : 0)),
                    p = c(i).parents(".AccordionPanelContentClip").length,
                    o = function() {
                        var a = c(i).closest(".AccordionPanelContent").prev();
                        a && a.length && !a.hasClass("AccordionPanelTabOpen") && (a.trigger("mousedown"), a.trigger("mouseup"))
                    };
                if (p) {
                    var l = c(i).closest(".AccordionPanelContent"),
                        j = d.scrollTop(),
                        r = d.scrollTop() + d.height(),
                        s = d.scrollLeft() +
                        d.width(),
                        d = d.scrollLeft(),
                        r = g.top >= j && g.top + l.height() <= r,
                        g = g.left >= d && g.left + l.width() <= s;
                    if (r && g) return o(), !1;
                    n = r ? j : Math.min(n, c(i).parents(".AccordionWidget").offset().top);
                    q = g ? d : Math.min(q, c(i).parents(".AccordionWidget").offset().left)
                }
                d = function() {
                    m.scrollTo(q, n);
                    p && o();
                    try {
                        ...
                        if (!b.browser.msie || b.browser.version > 7) window.location.hash = k
                    }
                };
                try {
                ...
                if (window.scrollTo || void 0 !== a) {
                    ...
                    c({
                        ...
                        easing: f,
                        step: function(a) {
                            a != 0 && (y = a * (n - w), t = a * (q - x), m.scrollTo(x + t, w + y))
                        },
                        complete: d
                    })
                } else c("html,body").animate({
                    scrollTop: n,
                    scrollLeft: q
                }, 1E3, f, d);
                return !1
            }
        }(d = Muse.Utils.urlParam(f, "devicelock")) && Muse.Utils.createCookie("devicelock", d, 0);
        return !0
    };
    Muse.Utils.navigateToAnchor = function(a) {
        var b = function() {
            ...
            if (b.length !== 0) {
                var f = b.offset(),
                    d = c(window),
                    j = d.data("scrollWrapper"),
                    b =
                    j || window,
                    k = document.documentElement || document.body,
                    i = (j ? j.scrollHeight() : k.scrollHeight) - d.height(),
                    d = (j ? j.scrollWidth() : k.scrollWidth) - d.width(),
                    i = Math.min(i, f.top + (j && !j.isStandard() ? j.scrollTop() : 0)),
                    f = Math.min(d, f.left + (j && !j.isStandard() ? j.scrollLeft() : 0));
                b.scrollTo(f, i)
            }
        };
        if (c("body").hasClass("awaiting_bp_activate_scroll")) $window.one("scroll", function() {
            b()
        });
        else b()
    };
    ...
    Muse.Utils.redirectHyperlink = function(a) {
        ...
        else if (d = [], Muse.Utils.processHyperlink(a) && !Muse.Utils.isIBE()) {
    ...
    Muse.Utils.isRedirectLinkKeyboardAction =
        function(a) {
            return a.which == 13
        };
    Muse.Utils.addHyperlinkAnchor = function(a) {
        ...
        a.bind("mousedown", function(a) {
            (Muse.Utils.isMouseLeftClick(a) || Muse.Utils.isMouseMiddleClick(a)) && d.push(this)
        });
        a.bind("mouseup keyup", function(a) {
            if (Muse.Utils.isMouseLeftClick(a) && d.indexOf(this) != -1) a.ctrlKey || a.metaKey ? Muse.Utils.redirectHyperlinkInNewTab(this.href, a.shiftKey) : Muse.Utils.redirectHyperlink(this);
            else if (Muse.Utils.isMouseMiddleClick(a) && d.indexOf(this) != -1)
                if (b.browser.webkit || !a.target.href && b.browser.msie) Muse.Utils.redirectHyperlinkInNewTab(this.href,
                    a.shiftKey);
                else return d = [], !0;
    ...
    Muse.Utils.addHyperlinkBlock = function(a) {
        ...
        b.bind("mouseup keyup", function(b) {
            Muse.Utils.isMouseLeftClick(b) && d.indexOf(this) != -1 ? b.ctrlKey || b.metaKey ? Muse.Utils.redirectHyperlinkInNewTab(a.href,
                b.shiftKey) : Muse.Utils.redirectHyperlink(a) : Muse.Utils.isMouseMiddleClick(b) && d.indexOf(this) != -1 ? Muse.Utils.redirectHyperlinkInNewTab(a.href, b.shiftKey) : Muse.Utils.isRedirectLinkKeyboardAction(b) && Muse.Utils.redirectHyperlink(a);
            return !1
        });
    ...
    Muse.Utils.prepHyperlinks = function(a) {
        c("a.block").each(function() {
            ...
            a.find("a.nonblock").each(function() {
                var a = c(this);
                if (a.data("registeredNonBlockLink") ===
                    !0) return !1;
        ...
        c("a.nonblock").each(function() {
            var a = c(this);
            a.data("registeredNonBlockLink") !== !0 && (a.parent('[class~="sbg"]').length > 0 ? Muse.Utils.addHyperlinkAnchor(this) : (a.attr("class").match(/anim_(\w+)/) || this.href.indexOf("devicelock=") != -1) && c(this).bind("click", function() {
        ...
        var a = !1,
            ...
            k = function(d) {
                ...
                c("a.nonblock,a.block", d).each(function() {
                    Muse.Utils.saveHyperlinkInfo(c(this), l(c(this)), g, a, b)
                });
                b.sort(function(a,
                    b) {
            ...
            p = function() {
                ...
                var p, t, h = Math.max(0, g);
                for (g = Math.min(g + 2, b.length); h < g; h++)
                    if (p = b[h], o = p.$elem.offset().left + (m && !m.isStandard() ? m.scrollLeft() : 0), t = p.$elem.offset().top + (m && !m.isStandard() ?
                            m.scrollTop() : 0), p.from != (a ? o : t)) {
                        k(q);
                        break
                    }
                h = 0;
                for (g = b.length; h < g; h++) {
                    ...
                    p = p.hyperLinks;
                    t = void 0;
                    for (var y = 0; y < p.length; y++) t = l(p[y]), o && !p[y].hasClass(t) ? p[y].addClass(t) : !o && p[y].hasClass(t) && p[y].removeClass(t)
                }
            },
            o = function() {
                i || (i = !0, Muse.Utils.requestAnimationFrame(p))
            };
        (m = d.data("scrollWrapper")) ? m.registerUpdateCallback(o): d.scroll(o);
        c("body").on("muse_bp_activate", function(a, b, c) {
            j = !1;
            q = c;
            o()
        });
        0 == c(".breakpoint").length && p()
    };
    ...
    Muse.Utils.saveHyperlinkInfo = function(a, b, d, g, l) {
        var j = a.attr("href"),
            k = Muse.Utils.pathOnly(j),
            i = -1,
            m = a.attr("target"),
            n = window.location.href.replace(/#.*$/i, "");
        if (j && -1 != j.indexOf("#") && !(m && m != "_self") && !(0 <= k.indexOf("/")) && (n.charAt(n.length - 1) == "/" && (n += "index.html"), -1 != n.indexOf("/" + k, n.length - k.length - 1))) {
            var k = c(window).data("scrollWrapper"),
                q = j.substring(j.lastIndexOf("#")),
                a = a.parent('[class~="sbg"]').length > 0 || a.hasClass("block") ? a.parent() : a,
                p = "#" + a.attr("id"),
                b = "." + b;
            if (null !== Muse.Utils.allStyleSheetRules(d, function(a) {
                    return 0 <= a.indexOf(p + b) || 0 <= a.indexOf(b + p)
                })) {
                m = 0;
                ...
                if (-1 == i) {
                    d = Muse.Utils.getAnchorWithDestination(q);
                    if (d.length === 0) return;
                    m = k && !k.isStandard();
                    g = Math.floor(g ? d.offset().left + (m ? k.scrollLeft() : 0) : d.offset().top + (m ? k.scrollTop() : 0));
                    k = Number.MAX_VALUE;
                    m = 0;
                    for (n = l.length; m < n; m++)
                        if (l[m].href != j && l[m].from ==
                            g) {
                            i = m;
                            break
                        }
    ...
    Muse.Utils.getNaturalWidth = function(a) {
        var b = -1;
        a.naturalWidth != null ? b = a.naturalWidth : a.runtimeStyle ? (a.runtimeStyle.width = "auto", a.runtimeStyle.height = "auto", a.runtimeStyle.borderWidth = "0", a.runtimeStyle.padding = "0", b = a.offsetWidth, a.runtimeStyle.width = "", a.runtimeStyle.height = "", a.runtimeStyle.borderWidth = "", a.runtimeStyle.padding = "") : (a = a.cloneNode(!0), a.className = "", a.style.width = "auto !important", a.style.height = "auto !important", a.style.borderWidth = "0 !important",
            a.style.padding = "0 !important", b = a.width);
        return b
    };
    Muse.Utils.getNaturalHeight = function(a) {
        var b = -1;
        a.naturalHeight != null ? b = a.naturalHeight : a.runtimeStyle ? (a.runtimeStyle.width = "auto", a.runtimeStyle.height = "auto", a.runtimeStyle.borderWidth = "0", a.runtimeStyle.padding = "0", b = a.offsetHeight, a.runtimeStyle.width = "", a.runtimeStyle.height = "", a.runtimeStyle.borderWidth = "", a.runtimeStyle.padding = "") : (a = a.cloneNode(!0), a.className = "", a.style.width = "auto !important", a.style.height = "auto !important", a.style.borderWidth =
            "0 !important", a.style.padding = "0 !important", b = a.height);
        return b
    };
    ...
    Muse.Utils.needPIE = function(a) {
        ...
        else if (Muse.Utils.pieFunctionQueue.push(a), !Muse.Utils.pieLoading) Muse.Utils.pieLoading = !0, a = "scripts/pie.js", a[0] == "/" && (a = location.pathname.indexOf(".html") != -1 ? location.pathname.substring(0, location.pathname.lastIndexOf("/")) + a : location.pathname + a, a = a.replace(/\/+/g, "/")), c.ajax({
            url: a,
            dataType: "script",
            complete: function() {
    ...
    Muse.Utils.transformMarkupToFixBrowserProblemsPreInit = function() {
        ...
        b.browser.msie ? (b("html").addClass("ie"), b.browser.version < 8 && Muse.Utils.changeLItoDIVs(), b.browser.version < 9 && (Muse.Utils.monitorCheckboxes(), Muse.Utils.addRoundedCorners())) : b.browser.SafariMobile && b("body").css("-webkit-text-size-adjust",
            "none")
    };
    Muse.Utils.monitorCheckboxes = function() {
        ...
        c(".fld-checkbox input[type=checkbox]").each(function() {
            a(c(this))
        }).click(function() {
            a(c(this))
        });
        c(".fld-radiobutton input[type=radio]").each(function() {
            a(c(this))
        }).click(function() {
            c(".fld-radiobutton input[type=radio]", c(this).closest("form")).each(function() {
                a(c(this))
            })
        })
    };
    Muse.Utils.transformMarkupToFixBrowserProblems =
        function() {
            ...
            b.browser.msie && b.browser.version <= 9 && (b.browser.version <= 9 && (Muse.Utils.addGradientFill(), Muse.Utils.addShadows()), b.browser.version < 9 && (Muse.Utils.applyIEFilterToPNGImages(), Muse.Utils.addRGBA(), Muse.Utils.removeEdgeAnimationBorderForIE78()));
            (b.browser.msie && b.browser.version < 9 || b.browser.webkit) && Muse.Utils.insertEmptyDivAfterPinnedColumnElements();
            Muse.Utils.fixTransformRotations();
            Muse.Utils.fixImageFramesWithRoundedCorners();
            typeof window.matchMedia === "undefined" &&
                typeof window.msMatchMedia === "undefined" && c("html").addClass("nomediaqueries");
    ...
    Muse.Utils.fixSVGImages = function() {
        var a = document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"),
            b = c("html");
        a || (b.addClass("nosvg"), c("body img").each(function() {
            var a = c(this),
    ...
    Muse.Utils.maintainFluidSVGsAspectRatio = function() {
        ...
        if (0 != a.length) {
            ...
            c(window).resize(b);
            c("body").on("muse_bp_activate", function(a, c, j) {
                d(j);
                b()
            });
    ...
    Muse.Utils.addProtocolToVimeoYoutubeIfNeeded = function() {
        ...
        window && window.location && window.location.protocol && window.location.protocol.indexOf && 0 <= window.location.protocol.indexOf("file") && c("iframe").each(function() {
            var b = c(this),
                d = b.attr("src"),
                g = b.attr("data-src");
            d && g && "about:blank" == d && g.match && g.match(a) && b.attr("data-src", "https:" + g);
            !g && d && "about:blank" != d && d.match && d.match(a) && b.attr("src", "https:" + d)
        })
    };
        ...
        c(".rounded-corners").each(function() {
            ...
            Muse.Utils.needPIE(function() {
                ...
                if (!b.data("mu-ie-matrix")) {
                    var d = b.css("filter");
                    if (!d || !(d.toLowerCase().indexOf("opacity") > 0 && d.indexOf("=100") < 0)) {
                        if (a.childNodes.length && !Muse.Browser.Features.checkCSSFeature("border-radius") && (d = Muse.Utils.firstChild(a, Muse.Utils.Match.byNodeName("img"))) &&
                            ...
                            var d = c(d),
                                g = d.attr("src"),
                                l = b.css("background-color") + " ",
                                j = d.css("margin-left");
                            if (j == "0px" || j == "auto") j = d.css("padding-left");
                            var k = d.css("margin-top");
                            if (k == "0px" || k == "auto") k = d.css("padding-top");
                            if ((j == "0px" || j == "auto") && (k == "0px" || k == "auto")) b.addClass("museBGSize"), b.css("background-size", "cover");
                            d.css("visibility", "hidden");
                            b.css("background", l + "url(" + g + ") no-repeat " + j + " " + k)
                        }
                        PIE.attach(a)
                    }
                }
        ...
        var b = {},
            d = function(d) {
                var h = d.parent().hasClass("sbg") ? d.parent() : d,
                    d = c(d.children()[0]);
                h.attr("data-lightbox") != "true" && "fixed" != d.css("position") && h.height(d.outerHeight());
                h = d.attr("id") || "always_watch";
                b[h] || (b[h] = !0, d.watch("height", function() {
                    var b = c(this);
                    "fixed" != b.css("position") && !b.hasClass("fullscreen") && b.closest(a).children().length && b.closest(a).height(c(b.closest(a).children()[0]).outerHeight())
                }))
            };
        if (0 < c(".breakpoint").length) c("body").on("muse_bp_activate", function(g, l, j) {
            b = {};
            c(a, j).each(function() {
                c(this).attr("data-lightbox") != "true" && c(this).css("height", "auto");
                d(c(this))
            })
        });
        else c(a).each(function() {
            d(c(this))
        })
    };
    Muse.Utils.moveElementsOutsideViewport = function(a) {
        ...
        a.each(function() {
            b = c(this);
            b.css("display") === "none" && (b.attr("data-margin-left", b.css("margin-left")), b.css("margin-left", Muse.Utils.marginLeftForMovingElementsOutSideViewPort), b.css("display", "block"), b.attr("data-display-attr-change",
                "true"))
        })
    };
    Muse.Utils.moveElementsInsideViewport = function(a) {
        ...
        a.each(function() {
            b = c(this);
            b.attr("data-display-attr-change") === "true" && (b.css("display", ""), b.css("display") != "none" && b.css("display", "none"), b.css("margin-left", ""), b.css("margin-left") != b.attr("data-margin-left") && b.css("margin-left", b.attr("data-margin-left")), b.removeAttr("data-display-attr-change"), b.removeAttr("data-margin-left"))
        })
    };
    Muse.Utils.adjustTargetAndSlideHeights = function(a, b) {
        ...
        a.css("height", "");
        b != "loose" && (a.children().each(function() {
            c(this).children().length != 0 && (d = Math.max(d, c(this).innerHeight()));
            g = Math.max(g, c(this).innerHeight())
        }), l = d == 0 ? g : d, a.children().each(function() {
            if (!c(this).is("img"))
                if (c(this).hasClass("borderbox")) {
                    var a = c(this).outerHeight() - c(this).innerHeight();
                    c(this).css("height", l + a + "px")
                } else a = c(this).innerHeight() - c(this).height(), c(this).css("height", l - a + "px")
        }));
        b === "lightbox" ? a.css("height", l + "px") : a.css("height",
            a.outerHeight() + "px")
    };
    Muse.Utils.addWidgetIDToImages = function(a, b) {
        a.find("img").each(function() {
            c(this);
            c(this).attr("data-widget-id") === void 0 && c(this).attr("data-widget-id", b)
        })
    };
    Muse.Utils.resizeImages = function(a, b) {
        a.find("img").each(function() {
            var a = c(this);
            if (a.attr("data-heightwidthratio") !== void 0 && a.attr("data-widget-id") === b) {
    ...
    Muse.Utils.applyPinningToLightboxParts = function(a, b) {
        for (var d = 0; d < b.children().length; d++) {
            var g = c(b.children()[d]),
                l = g.parent(),
                j = g.attr("data-pintopage");
            if (j != void 0) {
                var k = !1;
                switch (j) {
                    case "page_fixedLeft":
                        var i = g.offset().left - a.offset().left,
                            m = a.offset().left - l.parent().offset().left,
                            k = !0;
                        break;
                    case "page_fixedCenter":
                        i = g.offset().left - (a.offset().left + a.width() / 2);
                        m = a.offset().left + a.width() / 2 - l.parent().offset().left;
                        k = !0;
                        break;
                    case "page_fixedRight":
                        i = g.offset().left - (a.offset().left +
                            a.width()), m = a.offset().left + a.width() - l.parent().offset().left, k = !0
                }
                k && Muse.Utils.isLeftInPercentForLightbox(l.parent()) && (j = m * 100 / l.parent().width(), l.css("margin-left", j + "%"), l.css("left", "0px"), g.css("left", i + "px"), g.css("margin-left", "0px"))
            }
        }
    };
    Muse.Utils.isLeftInPercentForLightbox = function(a) {
        var b = Muse.Utils.isPropertyInPercent(a, "margin-left") || Muse.Utils.isPropertyInPercent(a, "left");
    ...
    Muse.Utils.isPropertyInPercent = function(a, b) {
        ...
        var l = window.getComputedStyle(a[0]).getPropertyValue(b);
    ...
    Muse.Utils.removeEdgeAnimationBorderForIE78 =
        function() {
            c(".animationContainer").each(function() {
                c(this).parent().html(function(a, b) {
    ...
    Muse.Utils.initializeAnimations = function(a) {
        var b = function(b) {
            if (!Muse.Utils.isIBE() && !0 === a) {
                var d = b.contents();
                c("#report-abuse", d).remove();
                c("#report-abuse-spacer", d).remove()
            }
    ...
    Muse.Utils.fixTransformRotations = function() {
        Muse.Browser.Features.checkCSSFeature("transform") || c("*[data-mu-ie-matrix]").each(function() {
            ...
            b.css({
                "margin-bottom": "-=" + (b.innerHeight() -
                    l),
                "margin-right": "-=" + (b.innerWidth() - j)
            });
    ...
    Muse.Utils.fullPage = function(a) {
        ...
        if (0 == c(a).closest(".breakpoint").length) Muse.Assert.assert(0 ==
            c(".breakpoint").length, "Page is outside a breakpoint node."), b.init(c(a));
        else {
            var d = function(d) {
                Muse.Assert.assert(1 == d.length, "Cannot initialize sticky footer - invalid breakpoint node.");
                b.init(c(a, d))
            };
            d(c(".breakpoint.active"));
            c("body").on("muse_bp_activate", function(a, b, c) {
    ...
    Muse.Utils.endsWith = function(a,
        b) {
        if (!a || !b) return !1;
    ...
    Muse.Utils.getCSSIntValue = function(a, b) {
        return Muse.Utils.tryParse(a.css(b),
            parseInt, 0)
    };
    ...
    Muse.Utils.initWidget = function(a, b, d) {
        if (0 == c(".breakpoint").length) c(a).each(function() {
            d(c(this))
        });
        else {
            for (var g = 0; g < b.length; g++) {
                ...
                Muse.Utils._initWidgetQueue[l] || (Muse.Utils._initWidgetQueue[l] = []);
                Muse.Utils._initWidgetQueue[l].push({
                    id: a,
                    fn: d
                })
            }
                    ...
                    if (Muse.Utils._initWidgetQueue[a]) {
                        for (; Muse.Utils._initWidgetQueue[a].length;)
                            if (b = Muse.Utils._initWidgetQueue[a].shift(),
                                b = b.fn(c(b.id, d))) b.$bp = d, b.breakpoint = f;
                        Muse.Utils.showWidgetsWhenReady(d);
                        ...
                        if (d) c("body").off("muse_bp_activate", j), Muse.Utils._hasBPListener = !1
                    }
                };
                c("body").on("muse_bp_activate", j);
        ...
        function(a) {
            ...
            c("iframe, object", a).each(function() {
                ...
                if (!a.is("object") || !(b.browser.msie && b.browser.version < 9)) {
                    if (a.is("iframe")) {
                        var l = a.prop("src");
                        if ("" == l || !l || !l.indexOf) return;
                        if (a.attr("title") === "recaptcha widget") return;
                        if (0 <= l.indexOf("vimeo.com")) {
                    ...
                    l.$next =
                        a.next();
                    l.$parent = a.parent();
                    b.browser.msie ? (l.html = a.wrap('<div id="deleteMeWrapper"/>').parent().html(), a.remove(), l.$parent.children("div #deleteMeWrapper").remove()) : (l.$node = a.clone(), a.remove());
                    d.push(l)
                }
            });
            d.length && a.data("detached", d);
            h.length && a.data("paused", h);
            c("video", a).each(function() {
                if (b.browser.msie && b.browser.version == 9 && this.pause && this.getAttribute("autoplay") && this.readyState != 4) c(this).one("play", function() {
                    this.pause()
                });
    ...
    Muse.Utils.setPageToMaxWidth =
        function() {
            var a = c("#page");
            a !== void 0 && a.css("max-width") !== "none" && (a.css("width", a.css("max-width")), c(window).trigger("pageWidthChanged"))
        };
    ...
    Muse.Utils.getMinWidthOfElem = function(a) {
        ...
        b === 0 && (b = parseFloat(a.attr("data-min-width") ? a.attr("data-min-width") : 0));
        return b
    };
    Muse.Utils.dropInOneBucketOfSizeAndPinPolicy = function(a,
        b, d, g) {
        if (a !== void 0 && b !== void 0) {
            var l = {};
            if (b === "fixed") l = d.fixed;
            else if (b === "fluidWidth" || b === "fluidWidthHeight") l = d.responsive;
            if (!c.isEmptyObject(l)) switch (a) {
                case "page_fluidx":
                    l.ChildFluidPin.push(g);
                    break;
                case "page_fixedLeft":
                    l.ChildFixedLeft.push(g);
                    break;
                case "page_fixedRight":
                    l.ChildFixedRight.push(g);
                    break;
                case "page_fixedCenter":
                    l.ChildFixedCenter.push(g)
            }
        }
    };
    ...
    Muse.Utils.classifyChildrens = function(a, b, d) {
        function g(a) {
            var c = a.attr("data-pintopage"),
                ...
                n = !0;
            Muse.Utils.isTopLevelWidget(a) || a.is("form") || Muse.Utils.isMenuWidget(a) || Muse.Utils.isParameterizedHtmlWidget(a) ? b.ChildWidgets.push(a) : (g > 0 || h > 0) && !Muse.Utils.isParameterizedHtmlWidget(a) ? b.ChildWithMinWidth.push(a) :
                c !== void 0 && d !== void 0 ? (Muse.Utils.dropInOneBucketOfSizeAndPinPolicy(c, d, b, a), Muse.Utils.removeSizeAndPiningAttributes(a)) : n = !1;
            return n
        }
        d ? a && b && g(a) : a.children().each(function() {
            var a = c(this);
    ...
    Muse.Utils.getPropInPixel =
        function(a, b) {
            var c;
            a && b && a.css("display") !== "none" && (c = b === "margin-left" ? Muse.Utils.getMarginLeft(a) : window.getComputedStyle(a[0]).getPropertyValue(b), Muse.Utils.isInPercentage(c) && (b === "left" ? (c = a.offsetParent().width() * parseFloat(c) / 100, c = c.toString() + "px") : b === "margin-left" ? (c = a.parent().width() * parseFloat(c) / 100, c = c.toString() + "px") : c = a.css(b)));
            return c
        };
    ...
    Muse.Utils.setMinWidthInformation = function(a, b, d) {
        if (!c.isEmptyObject(a) && a.chosenMinWidth && a.$element && d > 0 && a.chosenMinWidth < d) a.$element = b, a.chosenMinWidth = d;
        return a
    };
    Muse.Utils.isParameterizedHtmlWidget = function(a) {
        return a.hasClass("size_fixed") || a.hasClass("size_fluid_width") || a.hasClass("size_fluid_width_height")
    };
    Muse.Utils.getLeft = function(a, b) {
        function c(a,
            d) {
            if (a && d) return b ? Muse.Utils.getPropInPixel(a, d) : d === "margin-left" ? Muse.Utils.getMarginLeft(a) : window.getComputedStyle(a[0]).getPropertyValue(d)
        }
        var d = {
            $element: a,
            left: c(a, "left")
        ...
        if (a.css("position") === "absolute") {
            var l = a.parent();
            if (l && l.hasClass("popup_anchor") && l.css("position") === "relative") d.$element = l, d.left = c(l, "left"), consultMarginLeft = !0
        }
        l = c(d.$element, "margin-left");
        if (l !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort)
            if (d.$element.css("position") === "static" || d.left === "auto") d.left =
                l;
            else if ((d.left === "0px" || d.left === "0%") && l !== "auto") d.left = l;
        if ((d.$element.css("position") === "static" || d.left === "0px" || d.left === "0%" || d.left === "auto") && l !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort) d.left = l;
        return d
    };
    Muse.Utils.getLeftAdjustmentAmountDoneByParents = function(a, b) {
        var d = a.attr("data-leftAdjustmentDoneBy"),
            g = 0;
        d !== void 0 && (d = d.split(","), d = d.filter(function(a, b, c) {
            return c.indexOf(a) == b
        }), c.each(d, function(a, d) {
            var h = c("#" + d);
            if (h[0] !== void 0 && b.closest(h).length) {
                var i =
                    Muse.Utils.getMarginLeft(h);
                if (Muse.Utils.isInPixel(i)) g += parseFloat(i);
                else if (Muse.Utils.isInPercentage(i) || i === "auto") Muse.Utils.moveElementsOutsideViewport(h), Muse.Utils.moveElementsOutsideViewport(h.parents()), i = Muse.Utils.getPropInPixel(h, "margin-left"), Muse.Utils.isInPixel(i) && i !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort && (g += parseFloat(i)), Muse.Utils.moveElementsInsideViewport(h), Muse.Utils.moveElementsInsideViewport(h.parents())
            }
            return !0
        }));
        return g
                ...
                case "page_fixedLeft":
                    a.forEach(function(a) {
                        var b = Muse.Utils.getChildWidth(a, c, !0),
                            ...
                            n = 0,
                            q = 0;
                        Muse.Utils.isInPercentage(b) ? (i = parseFloat(b) / 100, b = Muse.Utils.getWidths(a), q = b.elemWidth, f = b.offsetWidth) : Muse.Utils.isInPixel(b) && (i = a.offsetParent().width(), q = parseFloat(b), i = i > 0 ? q / i : 0);
                        i > 0 && (f > Math.round(q) && (n = f - Math.round(q)), b = Math.abs(Muse.Utils.isValueWithinTolerance(i,
                            1, 1.0E-4) ? a.outerWidth() : (m + n) / (1 - i)), Muse.Utils.setMinWidthInformation(d, a, b))
                    });
                    break;
                case "page_fixedRight":
                    a.forEach(function(a) {
                        var b = Muse.Utils.getChildWidth(a, c, !0),
                            f = 0,
                            i = window.getComputedStyle(a[0]).left,
                            i = Math.abs(i ? parseFloat(i) : 0);
                        Muse.Utils.isInPercentage(b) ? f = parseFloat(b) / 100 : Muse.Utils.isInPixel(b) && (f = a.offsetParent().width(), b = parseFloat(b), f = f > 0 ? b / f : 0);
                        if (f > 0 && f < 1 && !Muse.Utils.isValueWithinTolerance(f, 1, 1.0E-4)) var m = Math.abs(i / (1 - f));
                ...
                case "page_fixedCenter":
                    a.forEach(function(a) {
                        var b = window.getComputedStyle(a[0]).left,
                            b = b ? parseFloat(b) : 0,
                            f = Math.abs(b),
                            i = Muse.Utils.getMarginLeft(a),
                            m = 0,
                            n = Muse.Utils.getChildWidth(a, c, !0),
                            q = a[0].offsetWidth,
                            p = 0,
                            o = 0;
                        if (b !== 0) Muse.Utils.isInPercentage(i) ? m = parseFloat(i) / 100 : Muse.Utils.isInPixel(i) && (m = a.parent().width(), i = parseFloat(i), m = m > 0 ? i / m : 0), Muse.Utils.isInPercentage(n) ? (n = Muse.Utils.getWidths(a), o = n.elemWidth, q = n.offsetWidth) : Muse.Utils.isInPixel(n) && (o = parseFloat(n)), m > 0 && (b > 0 && q > Math.round(o) &&
                            (p = q - Math.round(o)), Muse.Utils.setMinWidthInformation(d, a, Math.abs((f + p) / m)))
                    })
            }
            return d
        };
    Muse.Utils.computeMinWidthForFixedChilds = function(a, b, d, g) {
        function l(a, b) {
            var d = 0,
                ...
                h = f.$element,
                j = f.left,
                l = Muse.Utils.isInPixel(j),
                f = Muse.Utils.isInPercentage(j) || j === "auto";
            Muse.Utils.moveElementsOutsideViewport(a);
            Muse.Utils.moveElementsOutsideViewport(a.parents());
            if (f) f = Muse.Utils.getLeft(a, !0), h = f.$element, j = f.left, l = Muse.Utils.isInPixel(j);
            var r = h.is(g) || g.closest(h).length,
                f = parseFloat(g.width());
            l && (d = parseFloat(j), r || (j = h.parents(), c.each(j, function(a, b) {
                var f = c(b);
                if (f.is(g)) return !1;
                f = Muse.Utils.getMarginLeft(f);
                Muse.Utils.isInPixel(f) && f !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort && (d += parseFloat(f));
                return !0
            })));
        ...
        if (a && a.length > 0) switch (b) {
            case "page_fluidx":
                a.forEach(function(a) {
                    var b =
                        Muse.Utils.getChildWidth(a, d, !1),
                        c = l(a, !0),
                        f = c.left,
                        c = c.containerWidth,
                        g = 0,
                    ...
                    c < f + b && (c = f + b);
                    g = c > 0 ? f / c : 0;
                    g < 1 && !Muse.Utils.isValueWithinTolerance(g, 1, 1.0E-4) && (p = Math.abs(b / (1 - g)));
                    Muse.Utils.setMinWidthInformation(j, a, p > b ? p : b)
                });
                break;
            case "page_fixedLeft":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, d, !1),
                        c = l(a).left,
                        c = Math.abs(c + b);
                    Muse.Utils.setMinWidthInformation(j, a, c > b ? c : b)
                });
                break;
            case "page_fixedRight":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, d, !1),
                        ...
                        f = -1,
                        l = Muse.Utils.getLeftAdjustmentAmountDoneByParents(a, g);
                    l >= 0 && (c -= l);
                    c > 0 && (f = Muse.Utils.isElementFixedSize(a) ? c : c + b);
                    Muse.Utils.setMinWidthInformation(j, a, f > b ? f : b)
                });
                break;
            case "page_fixedCenter":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, d, !1),
                        ...
                        p = 0,
                        o = -1;
                    Muse.Utils.isInPercentage(f) ? p = parseFloat(f) / 100 : Muse.Utils.isInPixel(f) && (p = a.parent().width(), f = parseFloat(f), p =
                        p > 0 ? f / p : 0);
                    p > 0 && (o = Muse.Utils.getLeftAdjustmentAmountDoneByParents(a, g), o = o < 0 ? 0 : o, f = (Math.abs(c) - o) / p, c < 0 ? c += o : c > 0 && (c -= o), Muse.Utils.isValueWithinTolerance(p, 1, 1.0E-4) || (l = (b + c) / (1 - p)), o = Math.max(f, l, b), Muse.Utils.setMinWidthInformation(j, a, o > b ? o : b))
                })
        }
        return j
    };
    Muse.Utils.computeMinWidthForChildsWithMinWidth = function(a, b) {
        ...
        a.forEach(function(a) {
            ...
            d !== void 0 && (j = Muse.Utils.computeMinWidthForFixedChilds([a],
                d, !0, b), Muse.Utils.setMinWidthInformation(c, a, j.chosenMinWidth))
        });
        return c
    };
    Muse.Utils.isTopLevelWidget = function(a) {
        return a && (a.hasClass("SlideShowWidget") || a.hasClass("PamphletWidget") || a.hasClass("TabbedPanelsWidget") || a.hasClass("AccordionWidget") || a.hasClass("Button"))
    };
    Muse.Utils.isMenuWidget = function(a) {
        return a.is("nav") && (a.hasClass("MenuBar") || a.hasClass("MenuBarVertical"))
    };
    Muse.Utils.computeMinWidthForForms = function(a) {
        function b(a) {
            a.children().each(function() {
                var a = c(this);
                if (a.attr("data-sizePolicy") ===
                    "fixed") {
                    d.push(a);
                    var g = a.innerWidth();
        ...
        d.forEach(function(b) {
            ...
            c.each(d, function(b, d) {
                ...
                if (f.is(a)) return !1;
                j = Muse.Utils.computeMinWidthForFixedChilds([f], k, !0, h);
                Muse.Utils.setMinWidthInformation(g, j.$element, j.chosenMinWidth);
                f.attr("data-min-width") && f.removeAttr("data-min-width");
                if (k = parseFloat(h.attr("data-min-width"))) j.chosenMinWidth =
                    Math.max(j.chosenMinWidth, k);
                h.attr("data-min-width", j.chosenMinWidth);
                f = h;
                if (h.is(a)) return !1
            })
        });
        var l = parseFloat(a.attr("data-min-width"));
        l > 0 && (a.css("min-width", l), a.removeAttr("data-min-width"))
    };
    Muse.Utils.computeMinWidthForWidgetChilds = function(a, b) {
        ...
        a.forEach(function(a) {
            ...
            if (!a.hasClass("SlideShowWidget") && !a.hasClass("PamphletWidget") && Muse.Utils.isElementFixedSize(a)) b = (b = window.getComputedStyle(a[0]).width) ?
                parseFloat(b) : 0, a.attr("data-min-width", b);
            else if (a.is("form")) Muse.Utils.computeMinWidthForForms(a);
            else {
                var c;
                a.hasClass("SlideShowWidget") || a.hasClass("PamphletWidget") ? c = WebPro.Widget.ContentSlideShow.prototype.defaultPlugins[0] : a.hasClass("TabbedPanelsWidget") ? c = WebPro.Widget.TabbedPanels.prototype.defaultPlugins[0] : a.hasClass("AccordionWidget") && (c = WebPro.Widget.Accordion.prototype.defaultPlugins[0]);
                c && c._setMinWidth && (c._setMinWidth(a, !0), b = Muse.Utils.getMinWidthOfElem(a))
            }(b > 0 || a.is("form")) &&
            d.push(a)
        });
        d.forEach(function(a) {
            ...
            h.$element && !c.isEmptyObject(h.$element) && h.$element.attr("data-min-width") && (h.$element.removeAttr("data-min-width"), Muse.Utils.removeSizeAndPiningAttributes(h.$element))
        });
        return g
    };
    Muse.Utils.adjustMinWidthRespectToAllParents = function(a, b) {
        ...
        b.forEach(function(b) {
            if (b && !c.isEmptyObject(b) &&
                b.$element && !c.isEmptyObject(b.$element) && b.chosenMinWidth > 0) {
                if (!a.is(b.$element)) {
    ...
    Muse.Utils.changeElementsDisplay =
        function(a) {
            ...
            a.each(function() {
                b = c(this);
                b.css("display") === "none" && (b.css("display", "block"), b.attr("data-display-attr-change", "true"))
            })
        };
    Muse.Utils.resetElementsDisplay = function(a) {
        ...
        a.each(function() {
            b = c(this);
            b.attr("data-display-attr-change") === "true" && (b.css("display", ""), b.css("display") !== "none" && b.css("display", "none"), b.removeAttr("data-display-attr-change"))
        })
    };
    Muse.Utils.isValueWithinTolerance = function(a, b, c) {
        return a === b ? !0 : !isNaN(a) && !isNaN(b) && Math.abs(a - b) <= c ? !0 : !1
    };
    Muse.Utils.getMinWidthOfParts =
        function(a, b, d) {
            function g(a) {
            ...
            function l(c) {
                ...
                if (d && b.attr("data-contentlayout") === "stack" && b.attr("data-transitionStyle") === "horizontal") {
                    var i = parseFloat(a.css("left"));
                    if (i > 0) {
                        var n = g.left - i,
                            g = g.right - i;
                        if (n > 0) c.left = n;
            ...
            function j(a) {
                if (b.attr("data-contentlayout") === "stack" && (b.attr("data-transitionStyle") ===
                        "horizontal" || b.attr("data-transitionStyle") === "vertical")) return a = a.attr("data-pintopage"), a === "page_fixedRight" || a === "page_fixedCenter";
                return !1
            }
            var k = -1;
            if (a && b && !c.isEmptyObject(a) && !c.isEmptyObject(b) && b[0] && a[0]) {
                ...
                var i = a.attr("data-sizePolicy"),
                    m = a.attr("data-pintopage"),
                    n = parseFloat(a.css("min-width"));
                ...
                var q = !1,
                    ...
                    a.innerWidth();
                if (j(a)) return k;
                n > 0 && (i = "fixed", r = n + v, q = !0, m === void 0 && (m = "page_fluidx"));
                if (i === "fixed") switch (m) {
                    case "page_fluidx":
                        i = -1;
                        o.left <= s.left ? (o = s.left - o.left, o >= 0 && (i = o / p)) : s.left - o.left < 2 && (i = 0);
                        i >= 0 && (Muse.Utils.isValueWithinTolerance(i, 1, 1.0E-4) ? k = 0 : i < 1 && (k = r / (1 - i)));
                        break;
                    case "page_fixedLeft":
                        q || (p = -1, o.left <= s.left ? p = s.left - o.left : s.left - o.left < 2 && (p = 0), p >= 0 && (k = r + p));
                        break;
                    case "page_fixedRight":
                        q || (p = -1, o.right >= s.right ? p = o.right - s.right : o.right - s.right < 2 && (p = 0), p >= 0 && (k = r + p));
                        break;
                    case "page_fixedCenter":
                        q || (p <= r ? k = r : s.left <= o.left || s.right >= o.right ? (p = o.left - s.left, i = s.right - o.right, p >= 0 && i <= 0 ? k = r + (o.right - s.right) : i >= 0 && p <= 0 && (k = r + (s.left - o.left))) : (s = s.left + r / 2, o = o.left + p / 2, p = -1, p = s === o ? 0 : s < o ? o - s : s - o, p >= 0 && (k = 2 * (r / 2 + p))))
                }
    ...
    Muse.Utils.getMinWidthForElement = function(a, b) {
        var c = a && a.length > 0 && a[0].style.minWidth !== "" ? parseFloat(a[0].style.minWidth) : 0,
            b = b || !1;
        if (a && a.length > 0 && a[0].style.minWidth ===
            "" || b) {
            ...
            l.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFluidPin, "page_fluidx", !1, a));
            l.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedLeft,
                "page_fixedLeft", !1, a));
            l.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedRight, "page_fixedRight", !1, a));
            l.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedCenter, "page_fixedCenter", !1, a));
            l.push(Muse.Utils.computeMinWidthForChildsWithMinWidth(d.ChildWithMinWidth, a));
            l.push(Muse.Utils.computeMinWidthForWidgetChilds(d.ChildWidgets, a));
            (d = Muse.Utils.adjustMinWidthRespectToAllParents(a, l)) && d.length > 0 && (c = Math.max.apply(null, d))
        }
        return c
    };
    Muse.Utils.buttonsMinWidthHelper =
        function() {
            ...
            c(".Button").each(function() {
                var a = c(this),
                    b = 0;
                !Muse.Utils.isElementFixedSize(a) && b === 0 && (b = Muse.Utils.getMinWidthForElement(a, !1), b > 0 && a.css("min-width", b));
                a.attr("data-visibility") === "changed" ? (a.css("visibility", ""), a.removeAttr("data-visibility")) : a.children() && a.children().attr("data-visibility") === "changed" && (a.children().css("visibility", ""), a.children().removeAttr("data-visibility"))
            });
    ...
    Muse.Utils.makeButtonsVisibleAfterSettingMinWidth =
        function() {
            ...
            else c("body").on("muse_bp_activate", function() {
                Muse.Utils.buttonsMinWidthHelper()
            })
        };
    Muse.Utils.attachIframesAndObjectsToResumeMedia = function(a) {
        ...
        if (b) {
            for (var d = b.length - 1; d >= 0; d--) {
                var g = b[d];
                !g.$next || g.$next.length == 0 ? g.$parent.append(g.$node ? g.$node : g.html) : g.$next.before(g.$node ? g.$node : g.html);
                g.$next = g.$parent = g.$node = g.html = void 0
            }
            a.data("detached", null)
        }
        if (b = a.data("paused"))
            for (d = 0; d < b.length; d++) g =
                b[d], g.playFn(g.$node);
    ...
    Muse.Utils.VimeoVideoHelper = function(a) {
        var b = [],
            ...
            l = function(b) {
                ...
                (!d || !d.length) && a("iframe").each(function() {
            ...
            j = function(a) {
                ...
                if (c) {
                    if ("ready" == c.event) {
                        ...
                        if (h && h.length)
                            for (var j = 0; j < h.length; j++) h[j]();
                        g.data("readyQueue", null)
                    }
                    for (j = 0; j < b.length;) g = b[j], g.source == a.source && g.method == c.method ? (g.callbackFn(c.value), b.splice(j, 1)) : j++
                }
            };
        window.addEventListener ? window.addEventListener("message", j, !1) : window.attachEvent("onmessage", j, !1);
        j = function() {};
        ...
        j.prototype.isPaused =
            function(a, b) {
                c(a, function() {
                    d(a, "paused", null, b)
                })
            };
        j.prototype.seekTo = function(a, b) {
            c(a, function() {
                d(a, "seekTo", b)
            })
        };
        j.prototype.isAutoPlay = function(a) {
            a = a.attr("src").split("?");
            a.shift();
    ...
    (function(a) {
        ...
        j.swapSources = function(a, b, c) {
            var d = a.attr("data-" + b);
            d &&
                !("src" == b && a.hasClass("ImageInclude") && a.attr("src").indexOf("images/blank.gif") == a.attr("src").length - 16 && a.parents(".SlideShowWidget").length) && ("src" == c && !a.attr("data-" + c) && a.attr("data-" + c, a.attr("src")), a.attr("src", d))
        };
        j.isRetina = function() {
        ...
        j.shouldUseCookie =
            0 < l.length;
        j.getResolutionPreference = function() {
            return Muse.Utils.readCookie("museresolution")
        };
        j.saveResolutionPreference = function(a) {
            Muse.Utils.createCookie("museresolution", a)
        };
        j.prototype.initializeHiDPIButton = function(b) {
            if (j.isRetina) {
                var c = this;
                l.filter(function() {
        ...
        j.prototype.activate = function(a) {
            ...
            j.isRetina && (!j.shouldUseCookie || "hidpi" == j.getResolutionPreference()) ? this.hidpiMode(a) : this.standardMode(a)
        };
        j.prototype.getCurrentMode = function() {
            return this._mode
        };
        j.prototype.setCurrentMode = function(a) {
            this._mode = a;
            if (j.isRetina) {
                switch (a) {
                    case "standard":
                ...
                j.shouldUseCookie &&
                    j.saveResolutionPreference(a)
            }
        };
        j.prototype.standardMode = function(c) {
            this.setCurrentMode("standard");
            b.removeClass("hidpi");
            a("img", c).each(function() {
                j.swapSources(a(this), "src", "hidpi-src")
            })
        };
        j.prototype.hidpiMode = function(c) {
            this.setCurrentMode("hidpi");
            b.addClass("hidpi");
            a("img", c).each(function() {
                j.swapSources(a(this), "hidpi-src", "src")
            })
        };
        j.prototype.getDataSrcAttrName = function() {
            return "standard" == this._mode ? c : d
        };
        a(window).data("ResolutionManager", new j)
    })(b);
    Muse.Utils.detectScreenResolution =
        function() {
            ...
            if (0 < c(".breakpoint").length) {
                var b = {};
                c("body").on("muse_bp_activate", function(c, d, l) {
                    c = l.attr("id");
                    b[c] || (a.activate(l), b[c] = !0)
                })
            } else a.activate()
        };
    ...
    Muse.Browser.Features.checkCSSFeature = function(a, b) {
        ...
        for (var c = c.charAt(0).toUpperCase() + c.substr(1), d = 0, l = Muse.Browser.domPrefixes.length; d < l; d++)
    ...
    Muse.Browser.Features.checkCSSValueCompatibility = function(a, b) {
        ...
        for (var l = 0; l < Muse.Browser.domPrefixes.length; l++) {
            var j = "-" + Muse.Browser.domPrefixes[l].toLowerCase() + "-" + b;
            c.style[a] = j;
            if (c.style[a] !== d) return Muse.Browser.domPrefixes[l]
        }
        return !1
    };
    Muse.Browser.Bugs = {};
    ...
    Muse.Browser.Bugs.CannotHandleClearBoth = b.browser.msie && 7 == b.browser.version;
    ...
    (function(a) {
        ...
        d.prototype.init = function(d) {
            ...
            if (0 != this.$verticalSpacer.length) {
                ...
                this.pageMinHeight = Muse.Utils.getCSSIntValue(d, "padding-top") + Muse.Utils.getCSSIntValue(d, "min-height") + Muse.Utils.getCSSIntValue(d,
                    "padding-bottom");
                ...
                b.resize(function() {
                    if (k) {
                        var a = b.width();
                        l ? (j.splice(0, j.length), j.push(a), l = !1, setTimeout(function() {
                            l = !0
                        }, 200)) : j[j.length - 1] != a && (j.push(a), 3 < j.length && j[j.length - 3] == j[j.length - 1] && (c.addClass("always_vert_scroll"), k = !1))
                    }
                    i.doUpdate()
                });
                this.doUpdate()
        ...
        d.prototype.doUpdate = function() {
            if (this.enabled &&
                ...
                var d = Math.round(this.contentAboveSpacer - this.$verticalSpacer.offset().top),
                    g = this.$verticalSpacer.offset().top + this.contentBelowSpacer < this.pageMinHeight;
                this.$verticalSpacer.css({
                    height: "calc(" + (a.browser.SafariMobile ? b.height() + "px" : "100vh") + " - " + (this.contentAboveSpacer + this.contentBelowSpacer) + "px " + (0 < d ? " + " : " - ") + Math.abs(d) + "px)",
                    "min-height": g ? d + this.minHeight + "px" : ""
                });
                d = (g ? d + this.minHeight : Muse.Utils.getCSSIntValue(this.$verticalSpacer, "min-height")) <
                    this.$verticalSpacer.height();
                g = !1;
                d && !c.hasClass("no_vert_scroll") ? (c.addClass("no_vert_scroll"), g = !0, a(window).trigger("resize")) : !d && c.hasClass("no_vert_scroll") && (c.removeClass("no_vert_scroll"), g = !0);
        ...
        l.prototype.updateScrollClass = function(a) {
                ...
                if (this.enabled)
                    if (this.initialized) {
                        ...
                        var c = this.$page.outerHeight(!0),
                            ...
                            a = Math.max(0, b.height() - this.pageMarginTop - this.pageMarginBottom - d - a);
                        a < this.spacerMinHeight && (a = this.spacerMinHeight + this.originalOffsetTop - this.$spacer.offset().top);
                        if (a != this.spacerHeight) {
                            this.pageResizeWatchEnabled = !1;
                            this.updateScrollClass(a);
                            this.$spacer.css("height", a);
                            if (a < this.spacerHeight && c == this.$page.outerHeight(!0)) a = this.spacerHeight, this.updateScrollClass(a),
                                this.$spacer.css("height", a);
                            this.pageResizeWatchEnabled = !0
                        }
        ...
        l.prototype.calculateInitialSpacerHeight = function() {
        ...
        l.prototype.onPageHeightChanged = function(a) {
        ...
        var j = null,
            j = a(".muse_check_css"),
            k = j.css("height", "100vh").height(),
            i = j.css("height", "calc(100vh + 300px)").height();
        0 < k && 0 < i && 300 == i - k ? (j.remove(), j = new d) : (a("html").removeClass("css_verticalspacer"), j = new l);
        b.data("stickyFooter", j)
    })(b);
    Muse.Utils.requestAnimationFrame = function() {
    ...
    Muse.Utils.animationFrameFx = function(a) {
        var b = a.fx;
        a.extend(b, a.fx);
        var c, d = a(window).data("stickyFooter"),
            l = function() {
                c && (Muse.Utils.requestAnimationFrame(l), b.tick(), d.doUpdate())
            };
        b.timer = function(b) {
            b() && a.timers.push(b) && !c && (c = !0, l())
        };
        b.stop = function() {
            c = !1
        };
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2018.0.0.379" != d.getAttribute("content") && Muse.assets.outOfDate.push("museutils.js");
                    break
                }
            }
        }
